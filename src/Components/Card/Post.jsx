...
export default class Post extends React.Component {
    ...
    render() {
        const posts = this.props.data && this.props.data.map(post => {
            return (
                <div className="col-12 col-md-6 col-lg-3 my-3 px-5 px-lg-2" key={post.id}>
        ...
        return (
            <div className="d-flex flex-md-wrap" id="post" style={{transform : `translateX(${this.props.translate}%)`}}>
                {posts}
            </div>
        )
    }
